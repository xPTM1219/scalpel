...
pull requests in here. If anyone wants to add pull requests or report any
issue, I'll be ready to review, test and merge them.
...
* asynchronous I/O that allows disk operations to overlap with pattern matching
  this results in a substantial performance improvement
* regular expression support for headers/footers
* embedded header/footer matching for better processing of structured file
  types that may contain embedded files
...
### Expanding on the multi thread GPU

This is for advanced users. This feature is available only on
